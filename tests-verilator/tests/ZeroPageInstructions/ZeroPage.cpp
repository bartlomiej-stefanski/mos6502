...
class ZeroPageInstructions : public Mos6502
{
public:
  ZeroPageInstructions() : Mos6502(Mos6502::JumpVector{.reset = program_start})
  {
...
TEST_F(ZeroPageInstructions, StoreRegisterTests)
{
  ...
  tick(2);
  {
    ...
    EXPECT_EQ(bus->get< u8 >(sty_addr), cpu->REG_Y);
  }
  ...
  tick(2);
  {
    ...
    EXPECT_EQ(bus->get< u8 >(sta_addr), cpu->REG_A);
  }
}
